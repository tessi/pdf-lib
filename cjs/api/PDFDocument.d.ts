...
import { BoundingBox, PDFCatalog, PDFContext, TransformationMatrix } from "../core";
...
export default class PDFDocument {
     ...
     */
    embedPdfDocument(document: PDFDocument, pageIndex?: number): Promise<EmbeddedPDFPage>;
    /**
     * Embed a PDF page into this document.
     *
     * For example:
     ...
     * @returns Resolves with the embedded pdf page.
     */
    embedPdfPage(page: PDFPage, boundingBox?: BoundingBox, transformationMatrix?: TransformationMatrix): Promise<EmbeddedPDFPage>;
    /**
